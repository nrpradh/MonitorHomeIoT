...
const char* mqtt_client_id = "bedroom_one";

// MQTT Topics
const char* lamp_status_topic = "home/bedrooms/one/lamp/status";
const char* lamp_set_topic = "home/bedrooms/one/lamp/set";
const char* occupancy_topic = "home/bedrooms/one/occupancy";
